...
<!-- Header section -->
	...
	<div class="page-info-section page-info">
            <div class="container">
                ...
                <img src="{{ asset('frontend_assets/img/page-info-art')}}" alt="" class="page-info-art">
            </div>
        </div>
        <!-- Page Info end -->
        ...
        <div class="page-area product-page spad">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <figure>
                        <img class="{{ asset('frontend_assets/product-big-img')}}"src="{{ asset('uploads/product_photos')}}/{{$single_product_info->product_image}}" alt="">
                        </figure>
